 ...
 * @subpackage Instagram_Posts/views
...
class View {
	...
	public static function render_template( $template_name, $args = [], $template_path = '', $default_path = '' ) {
		...
		ob_start();
		do_action( 'instagram_posts_before_template_render', $template_name, $template_path, $located, $args );
		include( $located );
		do_action( 'instagram_posts_after_template_render', $template_name, $template_path, $located, $args );
	...
	public static function locate_template( $template_name, $template_path = '', $default_path = '' ) {
		if ( ! $template_path ) {
			$template_path = 'instagram-posts-templates/';
		}
		if ( ! $default_path ) {
			$default_path = Instagram_Posts::get_plugin_path() . 'app/templates/';
		}
		...
		if ( file_exists( $template ) ) {
			...
			return apply_filters( 'instagram_posts_locate_template', $template, $template_name, $template_path );
		} else {
			return false;
		}
	}
