<?php
use Instagram_Posts\Includes\i18n;
use Instagram_Posts\Includes\Dependency_Loader;
use Instagram_Posts\Core\Registry\Controller as Controller_Registry;
use Instagram_Posts\Core\Registry\Controller as Model_Registry;
use Instagram_Posts\App\Models\Settings;

require_once plugin_dir_path( __FILE__ ) . '/class-dependency-loader.php';


if ( ! class_exists( 'Instagram_Posts' ) ) {
	 ...
	 */
	class Instagram_Posts extends  Dependency_Loader {
		 ...
		 * @since    1.0.0
		 * @access   private
		 * @var      Instagram_Posts    $instance    Instance of this class.
		 */
		...
		private function set_locale() {
			...
			$plugin_i18n->set_domain( Instagram_Posts::PLUGIN_ID );
